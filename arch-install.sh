...
sudo pacman -S --noconfirm clang-format-git snapd nvidia fish neovim npm gdb steam discord lutris gimp vlc qbittorrent etcher powerline xorg-xkill nvidia-prime starship neofetch xclip wl-clipboard dotnet-sdk spotify-launcher docbook-xml intltool autoconf-archive gnome-common itstool docbook-xsl mallard-ducktype yelp-tools glib2-docs python-pygments python-anytree python-pip gtk-doc sddm ranger glow
