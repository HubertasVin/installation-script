...
with urllib.request.urlopen("https://wakatime.com/share/@35061e46-e6ae-4c54-9981-c98a50bfab17/0674e617-7e65-4143-b88f-848f35e7f359.json") as url:
    ...
    print("%{F#E57C46}7 days%{F-}: %{F" + getClockColor(sumH, 3) + "}"  + str(sumH) + ":" + str(sumM), end="%{F-}")
    print(" %{F#707880}|%{F-} %{F#42A5F5}today%{F-}: %{F" + getClockColor(data[6]['grand_total']['hours'], 1) + "}" + data[6]['grand_total']['digital'], end="%{F-}")
